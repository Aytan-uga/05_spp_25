...
- **Whole-plot** treatment factor: K fertilizer rates: 0, 30, 60 kgK/ha\
- **Split-plot**treatment factor: N fertilizer rates: 0, 100, 200 kgN/ha\
...
## SP randomization
```{r}
spp_rcbd_rand <-crossing(nrate_kgha = c(0, 100, 200),
...
#Defining numbers of rows and columns in the field for plotting purposes
spp_rcbd_layout <- spp_rcbd_rand %>%
